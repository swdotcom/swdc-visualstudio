...
namespace SoftwareCo
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SoftwareLogoutCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private SoftwareLogoutCommand(Package package)
        {
            if (package == null)
            {
        ...
        public static async void UpdateEnabledState(SoftwareUserSession.UserStatus userStatus)
        {
            if (menuItem != null)
            {
                ...
                {
                    // string emailTag = userStatus.email != null ? " (" + userStatus.email + ")" : "";
        ...
        /// </summary>
        public static SoftwareLogoutCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new SoftwareLogoutCommand(package);
        }
        ...
        {
            SoftwareUserSession.PluginLogout();
        }
    }
}
