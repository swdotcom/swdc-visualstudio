...
namespace SoftwareCo
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SoftwareSignupCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private SoftwareSignupCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static SoftwareSignupCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new SoftwareSignupCommand(package);
        }
