...
namespace Software
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SoftwareEnableMetricsCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private SoftwareEnableMetricsCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static SoftwareEnableMetricsCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new SoftwareEnableMetricsCommand(package);
        }
